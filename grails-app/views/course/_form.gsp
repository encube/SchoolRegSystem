<%@ page import="com.onb.SchoolRegSystem.Course" %>
...
<div class="fieldcontain ${hasErrors(bean: courseInstance, field: 'subjects', 'error')} ">
	...
	<g:select name="subjects" from="${com.onb.SchoolRegSystem.Subject.list()}" multiple="multiple" optionKey="id" size="5" value="${courseInstance?.subjects*.id}" class="many-to-many"/>
</div>
